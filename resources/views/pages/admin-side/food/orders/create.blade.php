...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">🍽️ New Food Order</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('food.orders.store') }}" method="POST" id="foodOrderForm">
                @csrf
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="guest_name" id="guestName"
                                            ...
                                            value="{{ old('guest_name') }}" placeholder="Saqib Din">
                                        @error('guest_name')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="order_type" class="form-select">
                                            @foreach (['Room Service', 'Dine In', 'Takeaway'] as $t)
                                                <option value="{{ $t }}"
                                                    {{ old('order_type', 'Room Service') === $t ? 'selected' : '' }}>
                                                    {{ $t }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-receipt me-2"></i>Place Food Order
                                    </button>
                                    <a href="{{ route('food.orders.index') }}" class="btn btn-outline-secondary">
