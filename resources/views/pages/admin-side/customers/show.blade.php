                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="text-muted d-block">{{ $booking->room->type ?? '' }}</small>
                                        </td>
                                        <td>{{ $booking->check_in->format('d M Y') }}</td>
                                        <td>{{ $booking->check_out->format('d M Y') }}</td>
                                        <td><span class="badge bg-light-secondary">{{ $booking->nights }}n</span></td>
                                        <td class="text-success fw-500">₨{{ number_format($booking->total_amount) }}</td>
                                        <td>
