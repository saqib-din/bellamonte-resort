                ...
                <div class="col-md-12">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <Link :href="`/bookings/${booking.uuid}/edit`" class="btn btn-primary"><i class="ti ti-edit me-1"></i> Edit</Link>
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            <tbody>
                                ...
                                <tr><td class="text-muted fw-500">Duration</td><td><span class="badge bg-light-secondary">{{ booking.nights }} nights</span></td></tr>
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2"><span class="text-muted">Room Price/Night</span><span>₨{{ n(booking.room_price) }}</span></div>
                    <div class="d-flex justify-content-between mb-2"><span class="text-muted">Nights</span><span>× {{ booking.nights }}</span></div>
                    <hr>
            ...
            <div class="card">
                ...
                <div class="card-body d-grid gap-2">
                    <Link :href="`/bookings/${booking.uuid}/edit`" class="btn btn-outline-primary"><i class="ti ti-edit me-1"></i> Edit Booking</Link>
